...
const BookingDetail = ({ url }) => {
    ...
    const commissionAmount = (totalPrice * booking.commissionPercent) / 100;
    ...
    return (
        <div className="detail-container">
            ...
            <div className="detail-info">
                ...
                <p><strong>Commission Amount:</strong> Rs. {commissionAmount}</p>
                ...
                <p><strong>Provider Earning:</strong> Rs. {booking.providerEarning || totalPrice - commissionAmount}</p>
